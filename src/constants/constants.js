export const projects = [
  ...
  },
  {
    ...
    description:
      "My first front-end project. One of my other passions is Brazilian Jiu-Jitsu. My inspiration to create this project is if i were to have my own Jiu-Jitsu school and i would like to have a website/brand similar to this one. I learned primarily how to use CSS Grid layout creating this project",
    image: "/images/2.svg",
    tags: ["HTML", "CSS", "Grid"],
  ...
  },
  {
    title: "Fight Gear",
    description:
      "I was inspired to create an online martial-arts clothing store. I primarily learned how to use Flexbox. Not a Mobile responsive website",
    image: "/images/3.svg",
  ...
  },
  {
    title: "Flooble",
    description:
      "I wanted to create a google mockup. This was to sharpen my Grid and Flex-box skills. Also turned navbar into a hamburger icon when viewed in mobile",
    image: "/images/4.svg",
...
export const TimeLineData = [
  { year: 2018, text: "Worked as a Wordpress Developer" },
  { year: 2018, text: "Started learning HTML & CSS" },
  {
    year: 2019,
    text: "Started Learning JavaScript",
  },
  { year: 2020, text: "Started creating projects and sharing on Github" },
  {
    year: 2021,
    text: "Continuing to learn new technologies and creating projects along the way",
  },
];
